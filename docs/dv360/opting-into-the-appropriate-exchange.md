...
![Exchanges list with the appropriate exchange checked](assets/dv360-exchanges-openx.png)
...
![Line item public inventory with the appropriate exchange checked](assets/dv360-public-inventory-openx.png)
